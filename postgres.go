...
// NewStore create postgres store instance,
// config postgres configuration,
...
// NewStoreWithDB create postgres store instance,
// db sql.DB,
// tableName table name (default oauth2_token),
// GC time interval (in seconds, default 600)
...
// NewStoreWithOpts create postgres store instance with apply custom input,
// db sql.DB,
// tableName table name (default oauth2_token),
// GC time interval (in seconds, default 600)
